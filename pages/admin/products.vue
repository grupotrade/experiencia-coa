...
<v-container>
        ...
        <v-col class="text-right">
            <v-tooltip bottom content-class="bottom">
                <template v-slot:activator="{ on }">
                    <v-btn text v-on="on" v-show="minimizedProductDialog" outlined color="primary" @click="maximizeNewProduct()">
    ...
    <ProductsUpdateProductDialog v-model="updateProductDialog" :product="productSelected" :user="user" v-if="productSelected != null" @finish="listProducts()" @minimize="minimizeProductDialog()" @cancel="cancelProductDialog()" />
    <ProductsNewProductDialog v-model="newProductDialog" :user="user" @finish="listProducts()" @minimize="minimizeProductDialog()" @cancel="cancelProductDialog()" />
...
export default {
    ...
    methods: {
        ...
        copyUrl(id) {
            navigator.clipboard.writeText('https://experiencia.coadental.com/product/'+ id)
        }
    }
}
</script>
