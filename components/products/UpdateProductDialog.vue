                ...
                <v-container>
                    <v-row dense>
                        <v-col>
                            ...
                            <v-text-field dense outlined class="body-1" background-color="foreground" v-model="product.tag" label="Etiqueta" color="secondary"></v-text-field>
                    ...
                    <v-row dense>
                        <v-col>
                            ...
                            <v-row dense>
                                <v-col cols="3" v-for="pdf in product.technicalFiles" :key="pdf">
                                    <h5 class="body-2">{{$fire.storage.refFromURL(pdf).name}}
                    ...
                    <v-row dense>
                        <v-col>
                            ...
                            <v-row dense>
                                <v-col cols="3" v-for="pdf in product.clinicFiles" :key="pdf">
                                    <h5 class="body-2">
                                        {{$fire.storage.refFromURL(pdf).name}}
...
export default {
    ...
    methods: {
        ...
        updateProduct() {
            this.$fire.firestore.collection('products').doc(this.product.id).update({
        ...
        removePdf(pdf) {
            const indexOf = this.product.technicalFiles.indexOf(pdf)
            if (indexOf > -1) {
        ...
        removeClinicPdf(pdf) {
            const indexOf = this.product.clinicFiles.indexOf(pdf)
            if (indexOf > -1) {
